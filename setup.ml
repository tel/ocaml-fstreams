...
(* OASIS_START *)
(* DO NOT EDIT (digest: ac554cbc9eb45ada35ea0fc564129d07) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Finite"; "Infinite"];
                      lib_pack = true;
                      lib_internal_modules = ["Option"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "fstreams";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\159¯\003\007(+Óü\144rpÆ¤Jåd";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
