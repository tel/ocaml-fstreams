...
(* OASIS_START *)
(* DO NOT EDIT (digest: 661039abf374e2ec5cc0f7fbc9b92d0d) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Partial"; "Total"; "Void"];
                      lib_pack = true;
                      lib_internal_modules = ["Option"; "Internal"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Fstreams";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/tel/ocaml-fstreams";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "z\r²ò?ÈÍØ\159ýµæÁ\139\140?";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
