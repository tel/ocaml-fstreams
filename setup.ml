...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6a24ef91edba551fbbaf3579a255e9d6) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Fstreams"];
                      lib_pack = false;
                      lib_internal_modules = ["Option"; "Void"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\018rc\242\t&\007\151t\171f9Q\029\224\178";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
